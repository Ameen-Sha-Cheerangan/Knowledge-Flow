...
// import { ReactComponent as NitcIcon } from './NITC_Logo.svg'; // Ensure this path is correct
    ...
    <nav className='h-14 bg-[#23272F] border-b border-gray-600 text-[#f6f7f9] flex justify-between px-3  items-center  fixed w-full z-10'>
      <Link className='text-lg' to='/'>
        <div className='flex gap-1 justify-center items-center'>
          <div className='flex justify-center text-2xl items-center text-[#406242]'>
            <RedditIcon />
          </div>
      ...
      <div className='flex items-center gap-5'>
        {!isLoggedIn && (
          <button
            ...
            className='hidden max-h-[38px] md:block hover:brightness-90 bg-[#406242] text-[15px] font-medium  rounded-2xl px-3 py-2 text-[#f6f7f9] shadow-md'
          >
            Log In
          </button>
        )}
